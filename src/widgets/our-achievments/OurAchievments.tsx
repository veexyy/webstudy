...
export function OurAchievments() {
  return (
    <div className="border-white border rounded-md  bg-transparent max-w-[900px] mx-auto">
      <WidgetTitle> Наши достижения </WidgetTitle>
      <div className="flex sm:gap-10 gap-5 px-4 md:px-0 justify-center sm:my-[70px] my-7">
